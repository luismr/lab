...
import com.luismachadoreis.tickets.web.config.SecurityContext;
...
@ContextConfiguration(classes = {WebAppContext.class, SecurityContext.class, UnitTestContext.class})
@WebAppConfiguration
