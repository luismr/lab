 ...
 */
public class ExampleUserDetailsAssert extends GenericAssert<ExampleUserDetailsAssert, CurrentUserDetails> {

    public ExampleUserDetailsAssert(CurrentUserDetails actual) {
        super(ExampleUserDetailsAssert.class, actual);
    }

    public static ExampleUserDetailsAssert assertThat(CurrentUserDetails actual) {
    ...
    public ExampleUserDetailsAssert isSignedInByUsingSocialSignInProvider(AuthenticatorService socialSignInProvider) {
        isNotNull();
