...
$config['database']['database'] = 'param-database-name';
$config['database']['table_prefix'] = 'mybb_';

$config['database']['hostname'] = 'param-database-host';
$config['database']['username'] = 'param-database-username';
$config['database']['password'] = 'param-database-password';
...
$config['memcache']['host'] = 'param-memcache-host';
$config['memcache']['port'] = param-memcache-port;
